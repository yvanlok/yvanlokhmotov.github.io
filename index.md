...
<div class="cta-buttons">
  ...
  <a href="/assets/pdf/CV_Yvan_Lokhmotov.pdf" class="btn">
  ...
  <a href="https://github.com/yvanlok" class="btn">
    <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16" style="vertical-align: middle; margin-right: 0.5rem;">
...
{% assign featured_projects = site.pages | where_exp: "page", "page.path contains 'projects/'" | where_exp: "page", "page.path != 'projects/index.md'" | where: "featured", true | sort: "date" | reverse %}
